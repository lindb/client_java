...
/**
 * DataQueryImpl implements {@link DataQuery} interface
 */
public class DataQueryImpl extends BaseQuery implements DataQuery {
	 ...
	 */
	@Override
	public ResultSet dataQuery(String database, String ql) throws Exception {
		return super.query(database, ql, ResultSet.class);
	}
	...
	public <T> Metadata<T> metadataQuery(String database, String ql) throws Exception {
		return super.query(database, ql, Metadata.class);
	}
}
